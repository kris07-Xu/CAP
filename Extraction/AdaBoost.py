...
import pandas as pd
import numpy as np
from sklearn.ensemble import AdaBoostRegressor  # 导入 AdaBoost 回归器
...
def optimize_ada(buffer_te, buffer_tris_hcl, buffer_hepes, buffer_pbs,
    ...
    # 预测CAP的萃取量值
    extraction_pred = ada_regressor.predict(input_features)
...
# 预测最优条件下的CAP的萃取量值
optimal_extraction = ada_regressor.predict(optimal_input)
